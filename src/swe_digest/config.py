"""Central configuration, loaded once from the top-level config.toml.

The TOML file drives behavior; this module maps it to typed constants so the
rest of the package keeps plain-name imports. config.toml sits outside the
...
with (ROOT / "config.toml").open("rb") as _handle:
