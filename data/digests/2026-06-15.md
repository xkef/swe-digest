...
- **Blurb:** Linus Torvalds released Linux 7.1 stable with a native NTFS driver, Intel FRED, and faster Arc graphics.
...
- **Blurb:** Anthropic retired Claude Sonnet 4 and Opus 4 models today at 09:00 PT with no grace period; successors are claude-sonnet-4-6 and claude-opus-4-8.
...
- **Blurb:** The EU Commission is assessing a US export-control directive that forced Anthropic to disable Fable 5 and Mythos 5 for all customers worldwide.
...
- **Blurb:** A second wave of obfuscated malicious AUR packages surfaced spanning Node.js, Plasma, Firefox, Aura, and Neovim packages.
...
- **Blurb:** Zhipu released GLM 5.2 to coding-plan tiers with one-million-token context; MIT-licensed open weights promised for the following week.
...
- **Blurb:** Anthropic's red-team report states frontier models can develop N-day exploits for Windows kernel vulnerabilities in hours instead of weeks.
...
- **Blurb:** NVIDIA published SkillSpector, an Apache-2.0 Python tool that scans AI agent skills for 64 types of vulnerabilities and security issues.
...
- **Blurb:** The curl project suspended vulnerability report handling for July 2026, resuming 2026-08-03; paid-support contracts retain full access.
...
- **Blurb:** Anthropic published a Swift package letting apps switch between Apple's on-device model and Claude through one unified framework API.
...
- **Blurb:** The n0 team released Iroh 1.0, a networking library addressing devices by public key rather than IP with a frozen v1 wire protocol.
...
- **Blurb:** Hetzner raised cloud and dedicated server prices effective 2026-06-15 at 08:00 CEST, with increases ranging from about 33 to 169 percent.
...
- **Blurb:** PlanetScale argues large Postgres DELETEs add work through dead tuples and vacuum pressure; partition-based DROP TABLE or TRUNCATE is preferable.
...
- **Blurb:** Yaron Minsky of Jane Street argues that formal methods are becoming economically viable as type systems and verification tooling mature.
...
- **Blurb:** Salesforce agreed to acquire Fin, the former Intercom, for $3.6 billion; the deal is expected to close in Q4 fiscal 2027.
...
- **Blurb:** Gabriel Weinberg argues AI adoption statistics overstate actual reliance, conflating trial use with sustained workflow integration.
...
- **Blurb:** Paul Graham's new essay on startup wealth creation drove discussion about whether success comes from luck or skill.
...
- **Blurb:** A GitHub issue and Hacker News thread allege a Rio de Janeiro city LLM is a model merge or fine-tune rather than independently trained.
