...
- **Blurb:** Apple raised entry MacBook and iPad prices 17% to 25% citing AI data center demand draining DRAM and NAND supply.
...
- **Blurb:** OpenAI will stagger GPT-5.6 for limited enterprise preview after US government agencies request customer-by-customer access review.
...
- **Blurb:** curl 8.21.0 fixed 18 CVEs on 2026-06-24, including CVE-2026-8932, an incomplete mTLS reuse flaw from 2001, the oldest curl issue.
...
- **Blurb:** CISA added CVE-2026-20230, an unauthenticated SSRF in Cisco Unified CM enabling file writes chainable to root code execution, to the KEV catalog.
...
- **Blurb:** Deno 2.9 added an experimental deno desktop tool to compile web frameworks to native binaries and enabled direct npm lockfile import.
...
- **Blurb:** An opinion essay argues Chinese open-weight models now deliver frontier coding quality at an order of magnitude lower cost than proprietary APIs.
...
- **Blurb:** Vesuvius Challenge digitally read a carbonized Herculaneum scroll end-to-end using X-ray microtomography and machine learning without opening.
...
- **Blurb:** Unconventional AI published Un-0, generating images via coupled-oscillator system, achieving ImageNet 64x64 FID comparable to early generators.
...
- **Blurb:** A challenge of 2,000 people failed to make an email AI assistant leak secrets using 6,000 emails, defended only by system-prompt rules.
...
- **Blurb:** CISA added CVE-2026-12569, an unauthenticated RCE in Windchill and FlexPLM via deserialization, to the KEV catalog citing active exploitation.
...
- **Blurb:** LastPass and BeyondTrust exposed business contact data in Klue OAuth breach affecting market-intelligence platform integrations with Salesforce.
...
- **Blurb:** GitHub experienced degraded Actions, Pull Requests, and Webhooks performance during strain attributed to AI agent traffic.
...
- **Blurb:** Zig redefined @bitCast on logical bit layout rather than raw memory, enabling endian-agnostic casts and producing a 5% compiler speedup.
...
- **Blurb:** According to unconfirmed industry reports, Apple will skip high-end M6 Mac processors and move directly to an AI-focused M7 line.
...
- **Blurb:** AMD submitted kernel patches adding HDMI 2.1 Fixed Rate Link support to the open-source AMDGPU driver, closing a long-standing licensing gap.
...
- **Blurb:** Oxide published an interactive 3D explorer of its rack-scale system design, detailing compute sleds, power distribution, and cabling choices.
...
- **Blurb:** The EU designated AWS and Azure as cloud gatekeepers under the Digital Markets Act despite not meeting quantitative thresholds, citing 70% share.
...
- **Blurb:** IBM demonstrated 0.7nm nanostack technology packing 100 billion transistors with 50% more performance or 70% better efficiency than 2nm.
...
- **Blurb:** Micron signed 16 strategic contracts locking memory prices through 2030 at historically high margins covering roughly 40% of its revenue.
...
- **Blurb:** OpenAI is reportedly leaning toward a 2027 IPO rather than pricing in 2026, after filing a confidential S-1 in June.
...
- **Blurb:** A widely discussed HN thread debates the limits of automated testing in capturing design taste and judgment in AI-generated code.
...
- **Blurb:** An Ask HN thread collects practitioner perspectives on how coding-agent adoption is reshaping software-engineering roles and skill emphasis.
...
- **Blurb:** A Show HN project indexes 18 years of Hacker News comments into a term-frequency trends tool revealing topic evolution over time.
