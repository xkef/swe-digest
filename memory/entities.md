...
- Neovim: editor. Track releases, LSP changes, Lua APIs, performance, plugin ecosystem, and breaking changes.
...
- OpenAI, Anthropic, Google DeepMind, Meta AI, Mistral, Hugging Face, NVIDIA: track model releases, API changes, pricing, inference infrastructure, open weights, and safety or security issues.

## Infrastructure

- GitHub, Cloudflare, AWS, Azure, Google Cloud, Vercel, Netlify, Fastly, Datadog, Sentry, npm, PyPI, Docker Hub: track outages, incident write-ups, postmortems, release changes, and security advisories.
